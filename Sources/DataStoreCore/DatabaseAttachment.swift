...
public protocol PersistentIdentifierProviding: AnyObject, Sendable {
    func resolvedPersistentIdentifier(for persistentIdentifier: PersistentIdentifier) -> PersistentIdentifier?
    func primaryKey<PrimaryKey>(for persistentIdentifier: PersistentIdentifier, as type: PrimaryKey.Type) -> PrimaryKey
    where PrimaryKey: LosslessStringConvertible & Sendable
}

public protocol DatabaseAttachment: AnyObject & Sendable, PersistentIdentifierProviding {
    nonisolated func makeObjectContext(editingState: some EditingStateProviding) -> (any DatabaseContext)?
}

public protocol DatabaseContext: AnyObject & Identifiable & Sendable, PersistentIdentifierProviding {}
