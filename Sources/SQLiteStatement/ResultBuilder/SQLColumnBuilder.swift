...
@resultBuilder package enum SQLColumnBuilder {
    package typealias Expression = any ColumnDefinition
    ...
    nonisolated package static func buildExpression(_ expression: SQLEmptyColumn) -> Component {
        []
    }
